...
const Gallery: React.FC<props> = ({ toList }: props) => {
  const characters = useSelector((state: IApplicationState) => state.comic.data.characters.items);
  const series = useSelector((state: IApplicationState) => state.comic.data.series.items);
  const stories = useSelector((state: IApplicationState) => state.comic.data.stories.items);
  const events = useSelector((state: IApplicationState) => state.comic.data.events.items);
